  ...
  return (
    <LayoutContainer narrow>
      <div className="prose prose-gray max-w-none">
        <h1 className="text-2xl font-extrabold text-brand-text mb-6">심심풀이 연구소 소개</h1>

        <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-6">
          <h2 className="text-lg font-bold text-brand-purple mb-3">🧠 우리는 어떤 서비스인가요?</h2>
          <p className="text-sm text-gray-600 leading-relaxed">
            심심풀이 연구소는 심리테스트, 월드컵, 밸런스게임, 퀴즈, 투표, 생성기를 무료로 즐길 수 있는 심심풀이 포털입니다.
